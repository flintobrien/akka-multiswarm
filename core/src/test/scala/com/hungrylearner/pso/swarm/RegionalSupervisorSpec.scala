...
class RegionalSupervisorSpec extends Specification with Mockito {
  ...
  class RegionalSupervisorUnderTest[F,P]( override val config: RegionalSwarmConfig[F,P],
    ...
    extends RegionalSupervisor[F, P] with RegionalId[F,P] with SingleEgoImpl[F,P] with RegionalTerminateOnAllSwarmingCompleted[F,P]
  {
...
//    override protected var bestPosition: Position[F, P] = _
    ...
    def proxy_tellChildren(newBestPositions: Seq[PositionIteration[F,P]], iteration: Int, progress: Progress, originator: ActorRef) = {}
    override protected def tellChildren(newBestPositions: Seq[PositionIteration[F,P]], iteration: Int, progress: Progress, originator: ActorRef) =
      proxy_tellChildren( newBestPositions, iteration, progress, originator)
  }
  ...
  "ProgressCounters" should {
    ...
    val bestPs = mock[Seq[PositionIteration[Int,Int]]]

    "  Increment counts and return 0 for unseen CompletedType or iteration." in {
      val counters = new ProgressCounters[Int,Int]
      val pr1 = ProgressReport[Int,Int](SwarmOneIterationCompleted, 1, bestPs, iteration=1, ProgressOneOfOne, TerminateCriteriaNotMet)
      val pr2 = ProgressReport[Int,Int](SwarmAroundCompleted, 1, bestPs, iteration=1, ProgressOneOfOne, TerminateCriteriaMetNow)
      val pr3 = ProgressReport[Int,Int](SwarmAroundCompleted, 2, bestPs, iteration=2, ProgressOneOfOne, TerminateCriteriaMetNow)
  ...
  "RegionalSupervisor" should {
    ...
    "  onProgressReport should report new best position to parent" in new AkkaTestkitSpecs2Support {
      ...
      val childIndex = 0
      val iteration = 1
      val pr = ProgressReport[Int,Int](SwarmAroundCompleted, childIndex, newBestPositions, iteration, ProgressOneOfOne, TerminateCriteriaMetNow)
      ...
      val epTrue = Seq( PositionIteration( position, iteration=1))
      ...
      val epBetter = Seq( PositionIteration( betterPosition, iteration=1))
    ...
    "  makeProgress should keep count of child progress." in new AkkaTestkitSpecs2Support {
      ...
      val child1a = ProgressReport[Int,Int](SwarmAroundCompleted, childIndex, newBestsEmpty, iteration=1, child0of2desc1of4, TerminateCriteriaNotMet)
      ...
      val child1b = ProgressReport[Int,Int](SwarmAroundCompleted, childIndex, newBestsEmpty, iteration=1, child1of2desc2of4, TerminateCriteriaNotMet)
      ...
      val child1c = ProgressReport[Int,Int](SwarmAroundCompleted, childIndex, newBestsEmpty, iteration=1, child1of2desc3of4, TerminateCriteriaNotMet)
      ...
      val child1Other = ProgressReport[Int,Int](SwarmOneIterationCompleted, childIndex, newBestsEmpty, iteration=1, child0of2desc1of4, TerminateCriteriaNotMet)
      ...
      val child1d = ProgressReport[Int,Int](SwarmAroundCompleted, childIndex, newBestsEmpty, iteration=1, child2of2desc4of4, TerminateCriteriaMetNow)
